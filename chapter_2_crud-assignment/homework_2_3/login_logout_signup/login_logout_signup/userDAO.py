...
class UserDAO:
	...
	def __init__(self, db):
		print("\n Thru: UserDAO, and subroutine: __init__ ")
		self.db = db
	...
	# makes a little salt
	def make_salt(self):
		print("\n Thru: UserDAO, and subroutine: make_salt ")
		salt = ""
		for i in range(5):
	...
	def make_pw_hash(self, pw,salt=None):
		print("\n Thru: UserDAO, and subroutine: make_pw_hash ")
	...
	def validate_login(self, username, password):
		print("\n Thru: UserDAO, and subroutine: validate_login")
		...
		try:
			...
			print("Fetched user name from mongo db: ", user)
		except:
