...
class SessionDAO:
	...
	def __init__(self, database):
		print("\n Thru: SessionDAO, and subroutine: __init__ ")
		self.db = database
	...
	def start_session(self, username):
		print("\n Thru: SessionDAO, and subroutine: start_session ")
	...
	def end_session(self, session_id):
		print("\n Thru: SessionDAO, and subroutine: end_session ")
	...
	def get_session(self, session_id):
		print("\n Thru: SessionDAO, and subroutine: get_session ")
	...
	def get_username(self, session_id):
		print("\n Thru: SessionDAO, and subroutine: get_username ")
	...
	def get_random_str(self, num_chars):
		print("\n Thru: SessionDAO, and subroutine: get_random_str ")
		random_string = ""
