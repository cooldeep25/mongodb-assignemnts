...
class BlogPostDAO:
	...
	def get_post_by_permalink(self, permalink):
		...
		print("\n Under class: BlogPostDAO / and subroutine: get_post_by_permalink")
	...
	def add_comment(self, permalink, name, email, body):
		...
		print("\n Under class: BlogPostDAO / and subroutine: add_comment")
